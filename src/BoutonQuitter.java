...
public class BoutonQuitter extends JButton implements MouseListener{
  ...
  public BoutonQuitter(String str){
    super(str);
    this.name = str;
    try {
      img = ImageIO.read(new File("image/Quitter.png"));
    } catch (IOException e) {
      e.printStackTrace();
    }
  ...
  public void mouseEntered(MouseEvent event) {    
    ...
    try {
      img = ImageIO.read(new File("image/Quitter_souris.png"));   
    } catch (IOException e) {
      e.printStackTrace();
    }    
  }
  ...
  public void mousePressed(MouseEvent event) {
    ...
    try {
      img = ImageIO.read(new File("image/Quitter_clic.png"));
      System.exit(0);
    } catch (IOException e) {
      e.printStackTrace();
    }    
